<template>
    <div id="navbar">
        ...
        <nav id="mobile-menu" class="lg:hidden grid grid-cols-2">
            ...
            <div v-if="menuActive" class="text-3xl font-medium text-center text-primary mt-20">
                <router-link v-if="user.data.role === 'Admin'" :to=" { name: 'admin' }" @click.native="switchMenu()" class="block mt-2">Admin</router-link>
            </div>
        </nav>
    </div>
</template>
